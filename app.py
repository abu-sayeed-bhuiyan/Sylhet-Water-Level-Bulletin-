...
raw_data = st.text_area("Insert filed data ( SMS format must be Station *Date *6PM(WL) *6AM(WL) *9AM(WL) *Rainfall( if any))", height=180, placeholder="Kan*150926*1050*1021*1016*0.0\n...")
