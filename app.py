...
raw_data = st.text_area("please insert field data( SMS format must be: Station Date 6PM 6AM 9AM Rainfall (if any) )  from GR:", height=180, placeholder="Kan*150926*1050*1021*1016*0.0\n...")
